...
@Disabled
@TeleOp(group = "Samples", name = "Velocity Motor Sample")
public class MotorVelocity_Sample extends OpMode {
    VelocityMotor motor;
    ...
    public void init() {
        ...
        motor = new VelocityMotor(hardwareMap, "veloMotor1", false); //3600 is the max ticks per second for a GoBilda 435rpm motor according to Gunnar
