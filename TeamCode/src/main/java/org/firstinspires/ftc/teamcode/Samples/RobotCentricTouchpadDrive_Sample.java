...
public class RobotCentricTouchpadDrive_Sample extends OpMode {
    ...
    public void loop() {
        ...
        /*
          ...
          This is controlled with the standardDrive() method, touchpad values, and joystick values.
         */
        drivetrain.standardDrive(driver.getFingerY(TouchpadFinger.FINGER_1), driver.getFingerX(TouchpadFinger.FINGER_1), driver.getStickX(Stick.RIGHT_STICK));
